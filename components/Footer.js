    ...
    <div>
      <footer className="text-gray-500 shadow-lg border-t-2 relative bg-white">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Game-On Sports</h2>
              <nav className="list-none mb-10">
                <li>
                  <Link legacyBehavior href={'/'}><a className="text-gray-500 hover:text-gray-800">Home</a></Link>
                </li>
                <li>
                  <Link legacyBehavior href={'/RegisterComplaint'}><a className="text-gray-500 hover:text-gray-800">Register Sport</a></Link>
                </li>
                <li>
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 Game-On — All Rights Reserved
